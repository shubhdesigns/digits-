          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-center space-x-4">
              ...
              {user ? (
                ...
                <>
                  <Link to="/login" className="px-4 py-2 rounded-md bg-white text-black hover:bg-gray-100 transition-colors">
                    Login
                  </Link>
                  <Link to="/register" className="px-4 py-2 rounded-md border-2 border-white text-white hover:bg-white hover:text-black transition-colors">
                    Register
                  </Link>
                </>
              )}
          ...
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            {user ? (
              ...
              <>
                ...
                <Link to="/register" className="block px-3 py-2 text-gray-300 hover:text-white">Register</Link>
              </>
            )}
          </div>
        </div>
